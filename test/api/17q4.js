...
describe('Vouching System', () => {
  ...
  describe('two clients', () => {
    beforeEach(function () {
      this.client1 = new WebSocket('ws://localhost:8000/api/17q4/client1/foo')
      this.clientVersion1 = BtpPacket.BTP_VERSION_1

      this.client2 = new WebSocket('ws://localhost:8000/api/17q4/client2/bar')
    ...
    it.skip('should deliver BTP to dummy ledger (17q4)', function (done) {
      let acked = false
